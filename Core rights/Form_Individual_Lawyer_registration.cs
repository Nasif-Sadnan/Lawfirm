...
{
    public partial class Form_Individual_Lawyer_registration : Form
    {
        ...
        public Form_Individual_Lawyer_registration(Form back_Panel)
        {
            this.back_Panel = back_Panel;

            InitializeComponent();
            Icn_Box_settings.IconChar = IconChar.Bars;
            TxT_Box_Lawyer_ID.Focus();
            if(back_Panel is Admin_All_Forms.Form_All_LawyerInfo)
            {
        ...
        {
            TxT_Box_Lawyer_ID.Text = "Enter your Lawyer ID no";
            TxT_Box_Lawyer_ID.ForeColor = Color.Silver;
        ...
        private void TxT_Box_Lawyer_ID_Enter(object sender, EventArgs e)
        {
            if(TxT_Box_Lawyer_ID.Text== "Enter your Lawyer ID no")
            {
                TxT_Box_Lawyer_ID.Text = "";
                TxT_Box_Lawyer_ID.ForeColor = Color.Black;
            }
        }
        private void TxT_Box_Lawyer_ID_Leave(object sender, EventArgs e)
        {
            if(TxT_Box_Lawyer_ID.Text=="")
            {
                TxT_Box_Lawyer_ID.Text = "Enter your Lawyer ID no";
                TxT_Box_Lawyer_ID.ForeColor= Color.Silver;
            }
        ...
        {
            if (TxT_Box_Name.Text == "" || TxT_Box_Gmail.Text == "" || TxT_Box_Lawyer_ID.Text == "" || TxT_Box_Judicial_ID_No.Text == "" || Cmbo_Box_District.Text == "" || Cmbo_Box_Division.Text == "" || TxT_Box_Password.Text == "" || TxT_Box_Name.Text == "Enter your name" || TxT_Box_Gmail.Text == "Enter your Gmail" || TxT_Box_Lawyer_ID.Text == "Enter your Lawyer ID no" || TxT_Box_Judicial_ID_No.Text == "Enter your Judicial ID no" || Cmbo_Box_District.Text == "Select District" || Cmbo_Box_Division.Text == "Select Division" || TxT_Box_Password.Text == "Enter your Password" || Cmbo_Box_LawyerType.Text=="" || Cmbo_Box_LawyerType.Text == "Select Type of lawyer")
            {
                MessageBox.Show(" Please enter all the datas");
            }
            else
            {
                SqlCommand cmd = new SqlCommand(@"INSERT INTO [dbo].[Individual Lawyer]
                    ([Lawyer ID ],
                     [Lawyer Name],
                     [Gmail],
                     [Division],
                     ...
                     [District],
                     [Password],[Type of lawyer])
                    VALUES      
                    ('" + TxT_Box_Lawyer_ID.Text + "','" + TxT_Box_Name.Text + "','" + TxT_Box_Gmail.Text + "', '" + Cmbo_Box_Division.Text + "','"+ TxT_Box_Judicial_ID_No.Text + "','" + Cmbo_Box_District.Text + "','" + TxT_Box_Password.Text + "','"+ Cmbo_Box_LawyerType .Text+ "')", conn);
                conn.Open();
                cmd.ExecuteNonQuery();
                conn.Close();
        ...
        private void add_Servicesconsultation()
        {
            ...
            SqlCommand cmd2 = new SqlCommand(@"INSERT INTO [dbo].[Service]
                    ([Service Name],
                     ...
                     [Payment])
                    VALUES      
                    ('" + servicename + "','" + TxT_Box_Lawyer_ID.Text + "','" + payment + "')", conn);
            conn.Open();
