...
{
    public partial class Form_Admin_Change_Password : Form
    {
        ...
        string ID;
        public Form_Admin_Change_Password(string ID)
        {
            InitializeComponent();
            this.ID = ID;
            Icn_Box_settings.IconChar = IconChar.Bars;
            LbL_ID.Text = "ID no : " + ID;
        }
        ...
        {
            Form_Admin_SendMail_ForPassCHnage form_Admin_SendMail_ForPassCHnage = new Form_Admin_SendMail_ForPassCHnage(ID);
            this.Hide();
            form_Admin_SendMail_ForPassCHnage.Show();
        }
        ...
        private string GetPasswordFromDatabase(string userID)
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string sql = "SELECT Password FROM [Admin] WHERE ID = @UserID";
        ...
        private void UpdatePasswordInDatabase(string userID, string newPassword)
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string sql = "UPDATE [Admin] SET Password = @NewPassword WHERE ID = @UserID";
