...
{
    public partial class Form_LawyerUnderFirm_Change_Password : Form
    {
        ...
        string ID;
        public Form_LawyerUnderFirm_Change_Password(String ID)
        {
            InitializeComponent();
            this.ID = ID;
        ...
        private string GetPasswordFromDatabase(string userID)
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string sql = "SELECT Password FROM [Lawyer Under Firm] WHERE [Judicial licence number] = @UserID";
        ...
        private void UpdatePasswordInDatabase(string userID, string newPassword)
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string sql = "UPDATE [Lawyer Under Firm] SET Password = @NewPassword WHERE [Judicial licence number] = @UserID";
