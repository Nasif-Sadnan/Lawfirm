...
{
    public partial class Form_User_Change_Password : Form
    {
        ...
        string ID;
        public Form_User_Change_Password(string ID)
        {
            InitializeComponent();
            this.ID = ID;
        ...
        {
            Form_User_SendMail_ForPassCHnage form_User_SendMail_ForPassCHnage = new Form_User_SendMail_ForPassCHnage(ID);
            this.Hide();
            form_User_SendMail_ForPassCHnage.ShowDialog();            
        }
        ...
        private string GetPasswordFromDatabase(string userID)
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string sql = "SELECT Password FROM [User] WHERE NID = @UserID";
        ...
        private void UpdatePasswordInDatabase(string userID, string newPassword)
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string sql = "UPDATE [User] SET Password = @NewPassword WHERE NID = @UserID";
