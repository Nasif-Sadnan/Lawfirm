...
namespace Core_rights
{
    public partial class Form_User_Login : Form
    {
        ...
        {
            TxT_Box_ID.Text = "Enter your user ID";
        ...
        {
            if (TxT_Box_ID.Text == "Enter your user ID")
            {
                TxT_Box_ID.Text = "";
        ...
        {
            Form_Login_Options form_Login_Options  = new Form_Login_Options();
            this.Hide();
            form_Login_Options.ShowDialog();
        }
        ...
        private void LbL_Reg_option_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            form_User_Registration.ShowDialog();
        }

        private void LbL_Reset_Pass_Click(object sender, EventArgs e)
        {
            if(TxT_Box_ID.Text== "Enter your user ID" || TxT_Box_ID.Text=="")
            {
        ...
        private bool CheckIfUserIDExists(string userID)
        {
            ...
            using (SqlConnection connection = new SqlConnection(@"Data Source=LAPTOP-368TJ83Q\SQLEXPRESS;Initial Catalog=""Core Rights"";Integrated Security=True"))
            {
                ...
                string query = $"SELECT COUNT(*) FROM [User] WHERE NID = @UserID";
        ...
        private void Icn_BtN_Register_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    string query = "SELECT * FROM [User] WHERE NID ='" + TxT_Box_ID.Text + "' AND Password='" + TxT_Box_Password.Text + "'";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        Form_Home_User form_Home_LawFirm = new Form_Home_User(userID);
