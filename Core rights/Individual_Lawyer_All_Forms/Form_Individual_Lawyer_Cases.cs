...
{
    public partial class Form_Individual_Lawyer_Cases : Form
    {
        public string ID;
        public Form_Individual_Lawyer_Cases(String ID)
        {
            InitializeComponent();
            this.ID = ID;
            LoadCaseINFO(ID);
        ...
        private void LoadCaseINFO(string ID)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                if (Cmbo_Box_lawFirmType.Text == "Select Case Type" || Cmbo_Box_lawFirmType.Text == "All")
                {
                    ...
                    string query = "SELECT [paid_status],[Case Name], [Case ID], [Lawyer ID],[Case Status],[paid_status],[review_status],[NID] FROM [Case] WHERE [Lawyer ID] = @ID ";
                ...
                else if (Cmbo_Box_lawFirmType.Text == "pending case" || Cmbo_Box_lawFirmType.Text == "running case" || Cmbo_Box_lawFirmType.Text == "closed case")
                {
                    ...
                    string query = "SELECT [paid_status],[Case Name], [Case ID], [Lawyer ID], [Case Status],[paid_status],[NID] FROM [Case] WHERE WHERE [Lawyer ID] = @ID AND [Case Status] = @Case_Status";
        ...
        private void Cmbo_Box_lawFirmType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                else if (Cmbo_Box_lawFirmType.Text == "pending case" || Cmbo_Box_lawFirmType.Text == "running case" || Cmbo_Box_lawFirmType.Text == "closed case")
                {
                    ...
                    string query = "SELECT [paid_status],[Case Name], [Case ID], [Lawyer ID], [Case Status],[paid_status],[NID] FROM [Case] WHERE [Lawyer ID] = @ID AND [Case Status] = @Case_Status";
            ...
            try
            {
                ...
                if (Case_ID > 0)
                {
                    using (SqlConnection connection = new SqlConnection("Data Source=LAPTOP-368TJ83Q\\SQLEXPRESS;Initial Catalog=Core Rights;Integrated Security=True"))
                    {
                        ...
                        string updateQuery = "UPDATE [Case] SET [Case Status] = 'running case',[paid_status]='not_paid' WHERE [Case ID] = @CaseID";
                    ...
                    MessageBox.Show("Accepted the case");
                }
                else
                {
        ...
        private void Close_Clicked(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Case_ID > 0)
                {
                    ...
                    MessageBox.Show("Closed the case");
                }
                else
                {
                    MessageBox.Show("Invalid Case ID.");
