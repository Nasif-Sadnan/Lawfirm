...
{
    public partial class Form_LawFirm_Registration : Form
    {
        ...
        Form backform;
        public Form_LawFirm_Registration(Form backform)
        {
            InitializeComponent();
        ...
        {
            if (TxT_Box_Name.Text == "Enter your Firm name")
            {
                TxT_Box_Name.Text = "";
        ...
        private void TxT_Box_Name_Leave(object sender, EventArgs e)
        {
            ...
            {
                TxT_Box_Name.Text = "Enter your Firm name";
        ...
        {
            if (TxT_Box_NID.Text == "Enter your Firm ID no")
            {
                TxT_Box_NID.Text = "";
        ...
        private void TxT_Box_NID_Leave(object sender, EventArgs e)
        {
            if (TxT_Box_NID.Text == "")
            {
                TxT_Box_NID.Text = "Enter your Firm ID no";
        ...
        private void IcN_Btn_clear_Click(object sender, EventArgs e)
        {
            ...
            Cmbo_Box_LawFirmType.Text = "Select Type of law Firm";
            Cmbo_Box_LawFirmType.ForeColor = Color.Silver;
        ...
        {
            if (TxT_Box_Name.Text == "" || TxT_Box_Gmail.Text == "" || TxT_Box_NID.Text == "" || Cmbo_Box_District.Text == "" || Cmbo_Box_Division.Text == "" || TxT_Box_Password.Text == "" || Cmbo_Box_LawFirmType.Text==""|| TxT_Box_Name.Text == "Enter your Firm name" || TxT_Box_Gmail.Text == "Enter your Gmail" || TxT_Box_NID.Text == "Enter your Firm ID no" || Cmbo_Box_District.Text == "Select District" || Cmbo_Box_Division.Text == "Select Division" || TxT_Box_Password.Text == "Enter your Password" || Cmbo_Box_LawFirmType.Text== "Select Type of law Firm")
            {
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand(@"INSERT INTO [dbo].[Law Firm]
                    ([Firm_ID],
                     [Firm_Name],
                     [Gmail],
                     [Division],
                     ...
                     [Firm_Type])
                    VALUES      
                    ('" + TxT_Box_NID.Text + "','" + TxT_Box_Name.Text + "','" + TxT_Box_Gmail.Text + "','" + Cmbo_Box_Division.Text + "','" + Cmbo_Box_District.Text + "','" + TxT_Box_Password.Text + "','"+Cmbo_Box_LawFirmType.Text+"')", conn);
                conn.Open();
                cmd.ExecuteNonQuery();
                conn.Close();

                add_Servicesconsultation();
                add_Servicesfilecheck();
        ...
        private void add_Servicesconsultation()
        {
            string servicename = "Taking consultation";
            int payment=500;
            SqlCommand cmd2 = new SqlCommand(@"INSERT INTO [dbo].[Service]
                    ([Service Name],
                     [Firm_ID],
                     [Payment])
                    VALUES      
                    ('" + servicename + "','" + TxT_Box_NID.Text + "','" + payment + "')", conn);
            conn.Open();
            cmd2.ExecuteNonQuery();
            conn.Close();
        }

        private void add_Servicesfilecheck()
        {
            string servicename = "File checking";
            int payment = 600;
            SqlCommand cmd2 = new SqlCommand(@"INSERT INTO [dbo].[Service]
                    ([Service Name],
                     [Firm_ID],
        ...
        private void Cmbo_Box_LawFirmType_Enter(object sender, EventArgs e)
        {
            if (Cmbo_Box_LawFirmType.Text == "Select Type of law Firm")
            {
                Cmbo_Box_LawFirmType.Text = "";
                Cmbo_Box_LawFirmType.ForeColor = Color.Black;
            }
        }

        private void Cmbo_Box_LawFirmType_Leave(object sender, EventArgs e)
        {
            if (Cmbo_Box_LawFirmType.Text == "")
            {
                Cmbo_Box_LawFirmType.Text = "Select Type of law Firm";
                Cmbo_Box_LawFirmType.ForeColor = Color.Silver;
            }
