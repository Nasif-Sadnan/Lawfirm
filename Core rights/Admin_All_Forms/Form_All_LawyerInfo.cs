...
namespace Core_rights.Admin_All_Forms
{
    public partial class Form_All_LawyerInfo : Form
    {
        ...
        private void Icn_BtN_Delete_Account_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                if (CmboBox_LawyerType.Text == "Select Lawyer type" || CmboBox_LawyerType.Text == "All")
                {
                    ...
                    string individualQuery = "SELECT [Lawyer Name], [Lawyer ID ] FROM [Individual Lawyer]";
        ...
        private void DisplayLawyerInfo3(DataRow row, int yOffset)
        {
            ...
            string Lawyer_ID = row["Lawyer ID "].ToString();

            Label idLabel = new Label();
            idLabel.Text = "Lawyer ID : " + Lawyer_ID;
            idLabel.AutoSize = true;
            ...
            delete_Icon.IconColor = System.Drawing.Color.FromArgb(61, 61, 61);
            delete_Icon.IconSize = 35;
            delete_Icon.Click += (s, EventArgs) => DeleteLawyer2(Lawyer_ID);
        ...
        private void DeleteLawyer2(string Lawyer_ID)
        {
            string connectionString = @"Data Source=LAPTOP-368TJ83Q\SQLEXPRESS;Initial Catalog=Core Rights;Integrated Security=True";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string deleteQuery2 = "DELETE FROM [Review] WHERE [Lawyer ID  ] = @Lawyer_ID";
                using (SqlCommand deleteCommand = new SqlCommand(deleteQuery2, connection))
                {
                    deleteCommand.Parameters.AddWithValue("@Lawyer_ID", Lawyer_ID);
                    deleteCommand.ExecuteNonQuery();
                }

                string deleteQuery5 = "DELETE FROM [Payment] WHERE [Lawyer ID  ] = @Lawyer_ID";
                ...
                string deleteQuery3 = "DELETE FROM [Case] WHERE [Lawyer ID  ] = @Lawyer_ID";
                ...
                string deleteQuery4 = "DELETE FROM [Service] WHERE [Lawyer ID  ] = @Lawyer_ID";
                ...
                string deleteQuery = "DELETE FROM [Individual Lawyer] WHERE [Lawyer ID  ] = @Lawyer_ID";
                using (SqlCommand deleteCommand = new SqlCommand(deleteQuery, connection))
                {
                    deleteCommand.Parameters.AddWithValue("@Lawyer_ID", Lawyer_ID);
                    deleteCommand.ExecuteNonQuery();
                ...
                MessageBox.Show("The lawyer is deleted");
                LoadLawyerInfo();
            }
        }
