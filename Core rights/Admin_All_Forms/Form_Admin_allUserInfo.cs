        ...
        private void DeleteLawyer(string NID)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string deleteQuery2 = "DELETE FROM [Review] WHERE [NID] = @NID";
                    ...
                    string deleteQuery5 = "DELETE FROM [Payment] WHERE [NID] = @NID";
                    ...
                    string deleteQuery3 = "DELETE FROM [Case] WHERE [NID] = @NID";
                    ...
                    string deleteQuery4 = "DELETE FROM [Service] WHERE [NID] = @NID";
