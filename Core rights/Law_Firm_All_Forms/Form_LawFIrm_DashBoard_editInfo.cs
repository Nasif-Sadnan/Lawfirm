...
{
    public partial class Form_LawFIrm_DashBoard_editInfo : Form
    {
        ...
        public Form_LawFIrm_DashBoard_editInfo(string ID)
        {
            InitializeComponent();
            this.firmID = ID;
        ...
        private void Icn_Pic_Edit_Done_Click(object sender, EventArgs e)
        {
            ...
            string updateQuery = "UPDATE [Law Firm] SET Password = @Password, Division = @Division, District = @District, Gmail = @Gmail WHERE Firm_ID = @FirmID";
                ...
                using (SqlCommand command = new SqlCommand(updateQuery, connection))
                {
                    ...
                    try
                    {
                        ...
                        if (rowsAffected > 0)
                        {
                            ...
                            Form_LawFIrm_DashBoard_showInfo showInfoForm = new Form_LawFIrm_DashBoard_showInfo(firmID, this);

                            this.Hide();

                            Form_LawFirm_Dashboard parentForm = this.ParentForm as Form_LawFirm_Dashboard;
